//
//  UnifiedHelperViews.swift
//  vibes
//
//  Unified row components that work with both Apple Music and Spotify.
//

import SwiftUI

// MARK: - Unified Track Row
...
// MARK: - Unified Artist Row

struct UnifiedArtistRow: View {
...
// MARK: - Unified Album Row

struct UnifiedAlbumRow: View {
...
struct UnifiedPlaylistRow: View {
    ...
    let onSendTapped: ((UnifiedPlaylist) -> Void)?

    init(playlist: UnifiedPlaylist, onSendTapped: ((UnifiedPlaylist) -> Void)? = nil) {
